...
class LoginScreen extends StatefulWidget {
  const LoginScreen({super.key, this.expectedRole = UserRole.estateManager});
      ...
      if (user != null) {
        ...
        if (user.role != widget.expectedRole) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                'Signed in as ${UserRole.label(user.role)} — routing by your account role.',
              ),
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      SignupScreen(role: widget.expectedRole),
                                ),
                              );
                            },
                            style: TextButton.styleFrom(
